...
git clone "${cacti_remote_prefix}/aho_corasick" ../aho_corasick
git clone "${cacti_remote_prefix}/anyhow" ../anyhow
git clone "${cacti_remote_prefix}/byteorder" ../byteorder
git clone -b patch "${cacti_remote_prefix}/cc" ../cc
git clone "${cacti_remote_prefix}/cfg_if" ../cfg_if
git clone "${cacti_remote_prefix}/cmake" ../cmake
git clone "${cacti_remote_prefix}/crc32fast" ../crc32fast
...
git clone "${cacti_remote_prefix}/half" ../half
git clone "${cacti_remote_prefix}/home" ../home
...
git clone "${cacti_remote_prefix}/minimal_lexical" ../minimal_lexical
git clone "${cacti_remote_prefix}/nom" ../nom
git clone -b patch "${cacti_remote_prefix}/once_cell" ../once_cell
git clone "${cacti_remote_prefix}/regex" ../regex
...
git clone "${cacti_remote_prefix}/smol_str" ../smol_str
git clone "${cacti_remote_prefix}/zip" ../zip
